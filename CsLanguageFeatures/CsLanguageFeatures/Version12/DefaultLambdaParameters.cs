...
namespace CsLanguageFeatures.Version12
{
    ...
    public class DefaultLambdaParameters
    {
        ...
        [Fact]
        public void DefaultParameter_ShouldBeSet_WhenOmitted()
        {
            // Arrange
            var lambda = (int a, int b = 0) => a > b;
        ...
        {
            // Arrange
            var lambda = (int a, int? b = null) => b != null && a > b;
        ...
        {
            // Arrange
            var lambda = (int a, int? b = 0) => b != null && a > b;
